      ...
      <Forms initialValues={{ text: "", title: "" }} onSubmit={onSubmit}>
        <div className="w-full flex flex-col gap-8 overflow-hidden border-2 border-zinc-200 p-6 rounded-md ">
          ...
          <div className="w-full flex justify-end gap-2">
            <button
              type="submit"
              className="bg-[#164e63] p-2 w-24 rounded-md text-white hover:bg-zinc-100 hover:text-zinc-700 transition duration-300 hover:border hover:border-[#164e63]"
            >
              ثبت دیدگاه
            </button>
            <button
              onClick={close}
              type="button"
              className="bg-zinc-100 p-2 w-24 rounded-md text-zinc-700  hover:bg-gray-400 hover:text-zinc-100 transition duration-300 border border-[#164e63]"
            >
              انصراف{" "}
            </button>
          </div>
