...
export default function AdsCard() {
  return (
    <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
      ...
      <div className="relative flex items-center space-x-3 rounded-lg bg-sky-950	 border border-gray-300  px-6 py-5 shadow-sm focus-within:ring-2 focus-within:ring-indigo-500 focus-within:ring-offset-2 hover:border-gray-400">
